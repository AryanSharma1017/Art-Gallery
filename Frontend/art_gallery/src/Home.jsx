...
const Home = () => {
    ...
    return (
        <div className='HomePage'>
            ...
            <div className='para'>
                <p>Welcome to Aboriginal Art Gallery, where creativity meets expression! Immerse yourself in a world of vibrant colors, captivating brushstrokes, and thought-provoking sculptures. Our gallery showcases the extraordinary talents of both established and emerging artists from around the globe. Explore a diverse range of artistic styles, from classical masterpieces to contemporary works pushing the boundaries of innovation. Whether you're a seasoned art enthusiast or just beginning your journey, there's something here to ignite your imagination and stir your soul. Join us on an inspiring visual journey as we celebrate the power and beauty of art in all its forms</p>
            </div>
        </div>
    );
};
